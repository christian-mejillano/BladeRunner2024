...
public class SendToMCP {
    ...
    public void sendMessage(String jsonToSend){
        ...
        try{
            ...
            System.out.println("There was an error with the address. Line 31 SendToMCPs.java");
            System.exit(0);
        }
        ...
        try{
            ...
            System.out.println("There was an error with sending the message. Line 43 SendToMCP.java");
        }
    }
