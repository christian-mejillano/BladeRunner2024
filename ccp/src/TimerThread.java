...
public class TimerThread implements Runnable{
    ...
    static Send sendMCP;
    static Send sendESP;
    static ReceiveMCP mcpReceive;
    static ReceiveESP espReceive;

    public TimerThread(){
        
    }

    public TimerThread(Send sendMCP, Send sendESP, ReceiveMCP mcpReceive, ReceiveESP espReceive){
        this.sendMCP = sendMCP;
        this.sendESP = sendESP;
        this.mcpReceive = mcpReceive;
        this.espReceive = espReceive;
        mainTimer = new Timer();
    }
